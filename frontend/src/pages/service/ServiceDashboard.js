                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <Input
                              ...
                              style={{ paddingLeft: '3.5rem' }}
                              className="bg-slate-800/50 border-slate-700 text-white rounded-xl h-12 focus:border-blue-500 focus:ring-blue-500/20 transition-all duration-300"
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <Input
                              ...
                              style={{ paddingLeft: '3.5rem' }}
                              className="bg-slate-800/50 border-slate-700 text-white rounded-xl h-12 focus:border-emerald-500 focus:ring-emerald-500/20 transition-all duration-300"
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                placeholder="0"
                                style={{ paddingLeft: '3.5rem' }}
                                className="bg-slate-800/50 border-slate-700 text-white rounded-xl h-12 focus:border-purple-500 focus:ring-purple-500/20 transition-all duration-300"
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Select value={formData.location_id} onValueChange={(value) => setFormData({ ...formData, location_id: value })}>
                                <SelectTrigger style={{ paddingLeft: '3.5rem' }} className="bg-slate-800/50 border-slate-700 text-white rounded-xl h-12 focus:border-purple-500 focus:ring-purple-500/20 transition-all duration-300" data-testid="location-select">
